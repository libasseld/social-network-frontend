export default function Login() {
    return (
      ...
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Connecte vous à votre compte </h2>
      </div>
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p class="mt-10 text-center text-sm/6 text-gray-500">
          ...
          <a href="/register" class="font-semibold text-indigo-600 hover:text-indigo-500"> Créez en Un</a>
        </p>
      </div>
    </div>
    )
